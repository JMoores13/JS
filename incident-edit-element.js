...
class IncidentEditElement extends HTMLElement {
  constructor() {
    super();
  ...
  async connectedCallback() {
    ...
    this.innerHTML = `
      ...
      .editor-button { background-color: #0000ffa2; color: white; border: none; padding: 0.5em 1em; border-radius: 4px; margin: 1em 0; }
      .delete-btn { background: none; border: none; color: #0026ffff; text-decoration: none; cursor: pointer; padding: 0; }
...
customElements.define("incident-edit-element", IncidentEditElement);